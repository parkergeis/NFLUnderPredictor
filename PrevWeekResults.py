...
# NFL Results log
finalScores = df[['game_id', 'season', 'week', 'weekday', 'gametime', 'home_team', 'home_score', 'away_team', 'away_score', 'total_line', 'total', 'over_odds', 'under_odds', 'spread_line', 'result', 'home_qb_name', 'away_qb_name', 'home_coach', 'away_coach']].dropna()
